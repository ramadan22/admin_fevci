...
@section("content")
                            ...
                            <tbody>
                                ...
                                @foreach($menu as $row)
                                    <tr>
                                        ...
                                        <td>
                                        <a type="button" href="#" class="btn btn-info btn-sm form-edit-menu" data-toggle="modal" data-target="#form" id="{{ $row['id_menu'] }},{{ $row['name_menu'] }}">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <form action="{{ url('configuration/update-menu') }}" method="POST">
                {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var $state = $(
                '<i class="'+state.element.value.toLowerCase()+'"></i> <span>&nbsp;'+state.element.value.toLowerCase()+'</span>');
                return $state;
            };
