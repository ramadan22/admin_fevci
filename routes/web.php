...
Route::get('configuration/change-privileges-user', 'config\ConfigController@changePrivilegesUser');
Route::post('configuration/update-privileges-user', 'config\ConfigController@updatePrivilegesUser');
